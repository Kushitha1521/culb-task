...
<body>
    <div class="navbar" >
        <h2 style="color:white; margin-left:2%; font-size:25px;">Register <!--navigation bar and logo -->
            <img src="image/ecsc logo.png" alt="HTML5 Icon" style="height: 60px;width: 80px; position:relative; left:75%;margin-top:1%;" >
        </h2>
	</div>
<div class="register"><!--resister form-->
 <form name='user' action='data.php' method='post'>
      
    
	  <h4 style="    text-align:center;   font-size:30px;"> Student Register </h4>
	
		<P> <label style=" font-size:20px;"> NAME &ensp; :- </label>
	  <input type="text" name="fname" style=" padding:0px 60px; font-size:20px; "></p><br>
	  
	  <P><label style="  font-size:20px;">EMAIL   &ensp;  :-</label>
	  <input type="email" name="femail" style=" padding:0px 60px; font-size:20px; "></p><br>
	  
	  <P><label style="  font-size:20px;">STUDENT ID:-</label>
	  <input type="text" name="fstudent_id" style=" padding:0px 60px; font-size:20px; "></p><br>
	  
	  <P><label style=" font-size:20px;">TEL NO &nbsp;:-</label>
	  <input type="text" name="ftelno" style=" padding:0px 60px; font-size:20px; "></p><br>
	 
	  <P><label style="  font-size:20px;">PASSWORD &ensp;&nbsp; :-</label>
	  <input type="password" name="fpassword" style=" padding:0px 7px; font-size:20px; "></p><br>
	  
	  <P><label style=";  font-size:20;">RE-PASSWORD:-</label>
	  <input type="password" name="frepassword" style=" padding:0px 7px; font-size:20px; "></p><br>
	      
	  <input type="submit" value="SUBMIT" style="padding:10px 30px; font-size:15px;  "  >
	  <input type="reset" value="RESET" style="padding:10px 30px; font-size:15px;  "> </fieldset><br> 
